...
-- Hook
--
hook.Add("Initialize", "ZINV_Initialize", function()
	nodes = {}
	total_chance = 0
	load_npc_info()
	found_ain = false
...
hook.Add("EntityKeyValue", "ZINV_NewKeyValue", function(ent)
...
hook.Add("OnNPCKilled", "ZINV_NPC_Explode", function(victim, killer, weapon)
...
hook.Add("OnNPCKilled", "ZINV_Headcrab_Check", function(entity, _, _)
...
-- Timer
--
timer.Create("ZINV_NPC_Type", timer_delay_npc_type, 0, function()
...
timer.Create("ZINV_NPC_Spawn", 1, 0, function()
	local status, err = pcall(function()
		local valid_nodes = {}
		local npcs = {}
		if simple_checks() then return end
