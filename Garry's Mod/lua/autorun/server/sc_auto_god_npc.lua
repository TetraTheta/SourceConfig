...
concommand.Add("sc_set_important", SetImportant, nil, "Set NPC important so that it won't take damage", 0)
concommand.Add("sc_unset_important", UnsetImportant, nil, "Unset NPC important so that it can take damage", 0)
